...
public class deleteProject extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 210, 140, -1));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 70, 370, -1));

        jPanel1.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 210, 200, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          try {
             ...
             String project_id=id.getSelectedItem().toString();
 
             Database db = new Database();
            if(db.DeleteProject(project_id))
            {
...
private void ID() 
    {try {
        ...
        while(rs.next())
        {
           id.addItem(rs.getString("project_id"));
        }
         } catch (Exception e) {
            System.out.println("SQL Exception: " + e.toString());
